    ...
    <>
      ...
      {isLoading && (
        <div style={{
          ...
          height: '100vh',
          display: 'flex',
          flexDirection: 'column', // Stack dots and text vertically
          ...
          {/* The Spinning Dots */}
          <div className="relative mb-12"> {/* Added bottom margin to push text down */}
            <style>{`
              .orbital {
                --d: 24.5px;
                width: 4px;
...
{/* The Message */}
          <div className="text-center animate-pulse">
            <p className={`text-sm font-black uppercase tracking-widest ${darkMode ? 'text-blue-400' : 'text-blue-600'}`}>
              Please wait...
            </p>
            <p className={`text-[10px] font-medium mt-1 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
